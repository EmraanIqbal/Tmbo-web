...
// import "./ExperienceDetailsOwner.scss";
...
const ExperienceDetailsOwner = (props) => {
    ...
    <>
      <section className="boat_detail_owner_main">
        <div className="custom-container">
          <div className="boats_detail_owner_inner exp_detail_host">
...
export default ExperienceDetailsOwner;
