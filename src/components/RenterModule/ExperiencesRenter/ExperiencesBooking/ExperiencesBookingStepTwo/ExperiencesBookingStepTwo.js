...
import "./ExperiencesBookingStepTwo.scss";
...
import ExperienceBoatOwner from "../../ExperienceBoatOwner/ExperienceBoatOwner";
const ExperiencesBookingStepTwo = () => {
      ...
      <div className="boats_booking_main">
        ...
        <div className="custom-container">
          <div className="boats_booking_inner_box">
            <Link className="back_to_detail" to="/experience-booking-one">
              <span>
...
export default ExperiencesBookingStepTwo;
