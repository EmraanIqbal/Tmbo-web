...
import mydocksinactive from "../../Assets/RenterImages/my-docks.png";
...
import creditcardwhite from "../../Assets/RenterImages/credit-card-white.png";
...
import { experienceDropdown } from "../../actions/createExperienceActions/experienceDropdownAction";
...
const SidebarExperiences = ({ children, newBoat }) => {
  ...
  const dropDown = useSelector((state) => state.expDropdown);
  ...
  const dropDownHandler = async () => {
    setIsLoading(true);
    await dispatch(experienceDropdown());
    const expDropDown = JSON.parse(localStorage.getItem("expDropDownInfo"));
    console.log("first::>", expDropDown);
    // if (expDropDown.data.experience === null) {
    navigate("/addnewExperiences");
    // }
    setIsLoading(false);
  };
        ...
        <Drawer variant="permanent" open={open}>
          ...
          <List className="nav-wrapper-sidebar">
            ...
            >
              <ListItemIcon>
                {/* <DirectionsBoatIcon /> */}
                <span className="my_boats_inactive">
                  <img src={bookingInactive} />
                </span>
                <span className="my_boats_active">
                  <img src={bookingactive} />
                </span>
              </ListItemIcon>
