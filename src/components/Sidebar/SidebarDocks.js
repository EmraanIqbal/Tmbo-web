...
import { dockDropdown } from "../../actions/createDockActions/dockDropdwnAction";
...
const SidebarDocks = ({ children, newBoat }) => {
              ...
              <>
                ...
                >
                  <Button
                    ...
                    startIcon={<AddIcon />}
                  >
                    Add New Dock {newBoat}
                    {loading && <div className="button-loader-boat"></div>}
                  </Button>
                </Typography>
                <Search className="db_navbar_search add_new_search">
                  <StyledInputBase
                    className="db_top_search_input"
                    placeholder="Search…"
