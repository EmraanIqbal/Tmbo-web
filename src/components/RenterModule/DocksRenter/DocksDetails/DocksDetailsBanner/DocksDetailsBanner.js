...
import "./DocksDetailsBanner.scss";
import BoatsBannerOne from "../../../../../Assets/RenterImages/docks-details.png";
...
const DocksDetailsBanner = (props) => {
    ...
    <>
      <section className="boats_banner_wrapper">
        <div className="custom-container">
          <h2 className="section-heding cruise-detail-hed">Dock Detail</h2>
          <Slider {...settings}>
...
export default DocksDetailsBanner;
